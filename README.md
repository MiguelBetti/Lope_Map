...
This map is part of the project El mundo de Lope de Vega (2024-2025). It shows the names of the places detected with machine learning in 376 plays. With this visualisation, users can search places and filter them by genre, subgenre and title of the plays.
