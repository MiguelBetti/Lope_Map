    ...
    <div className="p6o-welcome-wrapper">
      <div className="p6o-welcome">
        ...
        <p className="p6o-welcome-intro">
          Este mapa permite explorar los topónimos mencionados en el corpus de obras dramáticas de Lope de Vega (Madrid, 1562-1635). Son más de 850 nombres de imperios, reinos, ciudades, villas, parques, calles, edificios y accidentes geográficos, detectados en 378 obras.
        </p>
        <p>
